...
func GetBulkTeachersTable(dbConn *gorm.DB) table.Generator {
	return func(ctx *context.Context) table.Table {
		...
		formList.SetInsertFn(func(values form2.Values) error {
			...
			var reader provider.DataReader[dto.TeacherBatchCreateRequest]
			var filePath string
			...
			case "0":
				...
				reader = provider.NewTextReader[dto.TeacherBatchCreateRequest](text)
			...
			case "1":
				...
				reader = provider.NewCSVReader[dto.TeacherBatchCreateRequest](filePath, false)
